...
| <a name="input_server_group"></a> [server\_group](#input\_server\_group) | Configuration for creating a server group | <pre>object({<br/>    name     = string<br/>    policies = optional(set(string))<br/>  })</pre> | n/a | yes |
